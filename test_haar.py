...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Facial Expression real-time test with opencv haar detection')
    ...
    face_detector = cv2.CascadeClassifier('face_detection/HaarCascade/haarcascade_frontalface_alt.xml')
    emotion_classifier = torch.load('Resnet_GRU/rsenet_gru_best_checkpoint_0.943.pth',map_location=torch.device('cpu'))
