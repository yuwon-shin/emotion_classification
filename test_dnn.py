...
import time
import argparse
from face_detection.DNN.DNN import detectFaceOpenCVDnn
...
if __name__ == "__main__":
    ...
    # DNN = "CAFFE"
    if DNN == "CAFFE":
        modelFile = "face_detection/DNN/res10_300x300_ssd_iter_140000_fp16.caffemodel"
        configFile = "face_detection/DNN/deploy.prototxt"
        net = cv2.dnn.readNetFromCaffe(configFile, modelFile)
    else:
        modelFile = "face_detection/DNN/opencv_face_detector_uint8.pb"
        configFile = "face_detection/DNN/opencv_face_detector.pbtxt"
